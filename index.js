...
// Configuration
const apikey = 'ptla_KeTRcQygGdp45WyGgqadjHi0a1P35GI2bI6lKf0t94l';
const capikey = 'ptlc_EAf69JVZQ4XsLPwGvEX9DyR8f3IvI80kW8SAp75AQrY';
const domain = 'https://market.naell.my.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'samyonosamyoni@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8223984259:AAHsAazlUhvE4LOCfzSR1Ty-CAa38X7svjk';
const adminTelegramId = '7412613560';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'rynzz' && password === 'rahasia') {
    res.json({ success: true, user: { username: 'rynzz', role: 'admin' } });
  } else {
